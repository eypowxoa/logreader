...
test "$1" = '--archive' && rm build/logreader56/example.log && tar --create --directory build/logreader56 --file build/logreader56.tar.gz --gzip logreader56.config.php logreader56.php && rm -r build/logreader56
